document.addEventListener('DOMContentLoaded', () => {
  ...
  const messageLines = [
    "Hari ini adalah hari spesial karena kamu — alasan aku tersenyum setiap hari.",
    "Semoga semua harapanmu terkabul, dan bahagiamu bertambah setiap detik.",
    "Aku sayang kamu sampai ke bulan dan kembali 💫"
  ];
  ...
  let playing = false;
  function updatePlayBtnState(){ if(!playing){ playBtn.textContent = '🔊 Putar'; playBtn.classList.remove('btn-danger'); playBtn.classList.add('btn-outline-danger'); } else { playBtn.textContent = '🔈 Henti'; playBtn.classList.remove('btn-outline-danger'); playBtn.classList.add('btn-danger'); } }
  updatePlayBtnState();
  ...
  const surpriseBtn = document.getElementById('surpriseBtn'); const giftModal = document.getElementById('giftModal'); const giftBox = document.getElementById('giftBox'); const openGift = document.getElementById('openGift'); const closeGift = document.getElementById('closeGift'); const pdfWrap = document.getElementById('pdfWrap'); const pdfBtn = document.getElementById('pdfBtn');
